        ...
        $('#bootgrid-command').bootgrid({
            ...
            formatters: {
                commands: function(column, row) {
                    ...
                    return '<a href="{% url "candidate_detail" Candidate.id %}"> <button type="button" class="btn btn-flat btn-sm btn-info command-detail\" data-row-id="' + row.id + '"><em class="ion-person"></em></button> </a>' +
                        '<button type="button" class="btn btn-flat btn-sm btn-danger command-delete\" data-row-id="' + row.id + '"><em class="ion-trash-a"></em></button>' +
                        '<button type="button" class="btn btn-flat btn-sm btn-info command-edit\" data-row-id="' + row.id + '"><em class="ion-edit"></em></button>';
                }
            }
